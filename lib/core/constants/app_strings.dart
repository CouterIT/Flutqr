...
///
/// Bằng cách đặt tất cả text tại 1 nơi, khi cần sửa nội dung hiển thị
/// (sửa chính tả, thêm ngôn ngữ, thay đổi thông báo),
/// ta chỉ cần sửa trong file này mà không cần tìm kiếm khắp codebase.
